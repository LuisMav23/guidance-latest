                ...
                {data && (
                    <div className='flex flex-col gap-4'>
                        <div className="flex flex-row gap-4 w-full">
                            ...
                            <button onClick={downloadData} className="flex flex-row items-center gap-2 bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600 transition duration-300 ease-in-out w-fit">Download Data</button>
